# theme
    ...
    Output
      ggplot2::theme(
        ...
        title = NULL,
        spacing = grid::unit(11, units = "points"),
        margins = ggplot2::margin(t = 11, r = 11, b = 11, l = 11, unit = "points"),
        aspect.ratio = NULL,
        axis.title = NULL,
        ...
        axis.ticks = ggplot2::element_line(colour = "grey20", arrow = FALSE, arrow.fill = "grey20", inherit.blank = TRUE),
        axis.ticks.x = NULL,
        ...
        legend.box.margin = ggplot2::rel(0),
        legend.box.background = ggplot2::element_blank(),
        legend.box.spacing = ggplot2::rel(2),
        panel.background = ggplot2::element_rect(fill = "white", colour = NA, inherit.blank = TRUE),
        panel.border = ggplot2::element_rect(colour = "grey20", inherit.blank = TRUE),
        panel.spacing = NULL,
        panel.spacing.x = NULL,
        panel.spacing.y = NULL,
        panel.grid = ggplot2::element_line(colour = "grey92", arrow = FALSE, arrow.fill = "grey92", inherit.blank = TRUE),
