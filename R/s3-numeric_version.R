...
opts_numeric_version  <- function(constructor = c("numeric_version", "next", "atomic"), ...) {
  .cstr_combine_errors(
    constructor <- match_constructor(constructor, "numeric_version"),
...
opts_package_version  <- function(constructor = c("package_version", "next", "atomic"), ...) {
  .cstr_combine_errors(
    constructor <- match_constructor(constructor, "package_version"),
    ellipsis::check_dots_empty()
  )
...
opts_R_system_version  <- function(constructor = c("R_system_version", "next", "atomic"), ...) {
  .cstr_combine_errors(
    constructor <- match_constructor(constructor, "R_system_version"),
    ellipsis::check_dots_empty()
  )
