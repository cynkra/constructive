...
- [`construct_serialize()`](https://cynkra.github.io/constructive/reference/construct_serialize.md)
...
- [`opts_Layer()`](https://cynkra.github.io/constructive/reference/opts_Layer.md)
...
- [`opts_glue()`](https://cynkra.github.io/constructive/reference/opts_glue.md)
...
- [`opts_grouped_ts()`](https://cynkra.github.io/constructive/reference/opts_grouped_ts.md)
...
- [`opts_hms()`](https://cynkra.github.io/constructive/reference/opts_hms.md)
...
- [`opts_mixed_units()`](https://cynkra.github.io/constructive/reference/opts_mixed_units.md)
...
- [`opts_ordered()`](https://cynkra.github.io/constructive/reference/opts_ordered.md)
...
- [`opts_units()`](https://cynkra.github.io/constructive/reference/opts_units.md)
...
- [`opts_yearmonth()`](https://cynkra.github.io/constructive/reference/opts_yearmonth.md)
...
- [`opts_yearquarter()`](https://cynkra.github.io/constructive/reference/opts_yearquarter.md)
  : Constructive options for class 'yearquarter'

- [`opts_yearweek()`](https://cynkra.github.io/constructive/reference/opts_yearweek.md)
...
- [`opts_NULL()`](https://cynkra.github.io/constructive/reference/other-opts.md)
  ...
  [`opts_Guide()`](https://cynkra.github.io/constructive/reference/other-opts.md)
